...
export default function HomePage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4">
      <div className="relative bg-gradient-to-br from-orange-600 via-orange-700 to-gray-900 -mx-4 px-4 py-10 mt-[-64px] pt-[84px] mb-8 rounded-b-3xl overflow-hidden">
        ...
        <div className="relative text-center">
          <img src="/images/logo.png" alt="Granjita" className="w-[72px] h-[72px] rounded-2xl object-cover mx-auto mb-4 shadow-xl border border-white/20" />
          ...
          <div className="flex items-center justify-center gap-4 mt-4 flex-wrap">
            <div className="flex items-center gap-1.5 bg-white/10 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white/10">
              ...
              <span className="text-orange-100 text-xs font-medium">Frescos</span>
            </div>
            <div className="flex items-center gap-1.5 bg-white/10 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white/10">
              <svg className="w-3.5 h-3.5 text-orange-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-orange-100 text-xs font-medium">Envio a domicilio</span>
            </div>
            <div className="flex items-center gap-1.5 bg-white/10 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white/10">
              <svg className="w-3.5 h-3.5 text-orange-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-orange-100 text-xs font-medium">Pago facil</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          <div className="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-5 shadow-inner">
            <EmptyBoxIcon className="w-12 h-12 text-gray-300" />
          </div>
          <p className="text-gray-600 font-bold text-lg">No hay productos</p>
          <p className="text-gray-400 text-sm mt-1.5">Vuelve mas tarde</p>
        </div>
      ) : (
          ...
          <section key={category} className="mb-10 animate-fade-in">
            <div className="flex items-center gap-2.5 mb-4 px-1">
              <div className="w-10 h-10 bg-orange-50 rounded-xl flex items-center justify-center border border-orange-100">
                <CategoryIcon category={category} className="text-orange-500" />
              </div>
              <div>
